          ...
          <div class="container border mt-5">
            <div class="row">
              <div class="col">
                ...
                <h4 class="mt-5">Cadastro Empresa</h4>
                <hr>
                  
                  <form class="mt-4 mb-5" method="post" action="funcional/insert-empresa.php">
                    ...
                    <div class="form-group">
                      <label>CNPJ</label>
                      <input type="text" name="cnpj" class="form-control" minlength="14" maxlength="14" placeholder="00.000.000/0000-00" onkeypress="$(this).mask('00.000.000/0000-00')">
                    </div>
